...
#container = dec.DImageIntContainer()
#container.openSeries(tifname)
#img = container[1]
#npImage = img.data()

import fabio
img = fabio.open(tifname)

roiTopLeftX = 580
roiTopLeftY = 0
roiBottomRightX = 850
roiBottomRightY = 240
ROI = img.data[roiTopLeftY:roiBottomRightY, roiTopLeftX:roiBottomRightX]
ROIcbf = '/home/biocat/Shang/python/alignbeam/beamstop.cbf'
cbf = fabio.cbfimage.cbfimage(data = ROI)
cbf.write(ROIcbf)

mainFrame, subFrame = dec.display(ROIcbf)
time.sleep(20)
