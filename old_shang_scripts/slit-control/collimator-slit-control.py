...
topBladePV = '18ID:e:m1'
bottomBladePV = '18ID:e:m2'
inboardBladePV = '18ID:e:m3' # to be confirmed: inboard direction is -
outboardBladePV = '18ID:e:m4'
...
def main():
    ...
    form = MainDialog()
    form.setWindowTitle('Collimator slit blades control')
    form.show()
    sys.exit(app.exec_())
