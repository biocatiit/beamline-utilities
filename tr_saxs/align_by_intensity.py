...
def get_integrated_intensity(source_dir, fprefix, scan_num):
    flist = glob.glob(os.path.join(source_dir, '{}_{:04}_*.dat'.format(fprefix, scan_num)))
...
def align_by_intensity(source_dir1, fprefix1, scan_num1, source_dir2, fprefix2,
    ...
    offset = align_intensities(int1, int2)

    print offset

    flist = glob.glob(os.path.join(source_dir2, '{}_{:04}_*.dat'.format(fprefix2, scan_num2)))
    flist.sort(key=lambda x: int(x.split('_')[-1].split('.')[0]))
...
if __name__ == '__main__':
    ...
    scan_num1 = args.scan_num1
    scan_num2 = args.scan_num2
    ...
    align_by_intensity(source_dir1, fprefix1, scan_num1, source_dir2, fprefix2,
        scan_num2, choice='Scale and Offset')
